...
- [Tool Use with Claude](wiki/tool-use-with-claude.md) — extending Claude with Python tool functions for real-time data, date arithmetic, and external system integration
